...
class ItemActivityTest {
    ...
    fun itemActivityTest() {
        ...
        appCompatEditText2.perform(replaceText("200.00"), closeSoftKeyboard())
        ...
        appCompatEditText3.perform(replaceText("Movie Night"), closeSoftKeyboard())
